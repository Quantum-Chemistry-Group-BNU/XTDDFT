...
for i in range(orbenergy.shape[0]):
    ...
    # 能级能量
    if i == 0:
        ax.text(-0.7, energy-0.08, f"{energy:4.2f}", va="center", fontsize=15)
    elif i == 1:
        ax.text(-0.7, energy+0.08, f"{energy:4.2f}", va="center", fontsize=15)
    elif i == 2:
        ax.text(-0.7, energy-0.03, f"{energy:4.2f}", va="center", fontsize=15)
    elif i == 3:
...
ax.text(0.4, np.sum(orbenergy[0, 1])-0.08, "172(HOMO-1)", va="center", fontsize=15)
ax.text(0.4, np.sum(orbenergy[1, 1])+0.08, "173(HOMO)", va="center", fontsize=15)
ax.text(0.4, np.sum(orbenergy[2, 1])-0.03, "174(SOMO)", va="center", fontsize=15)
ax.text(0.4, np.sum(orbenergy[3, 1]), "175(SOMO)", va="center", fontsize=15)
ax.text(0.4, np.sum(orbenergy[4, 1]), "176(LOMO)", va="center", fontsize=15)
ax.text(0.4, np.sum(orbenergy[5, 1]), "177(LOMO+1)", va="center", fontsize=15)
